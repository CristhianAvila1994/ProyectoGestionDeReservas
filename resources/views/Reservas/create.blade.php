...
<div class="container"  style="width: 40%">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('reservas.store') }}" method="POST" id="delete-form">
                @csrf

                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1">Huesped</span>
                    <select  class="form-select" name="Huespedes_id" id="Huespedes_id" aria-label="Default select example">
                        <option value="">Seleccione</option>
                        @foreach ($huespedes as $huesped)
                        <option @if(old('Huespedes_id') == $huesped->id ) selected
                            @else
                ...
                <div class="input-group mb-3">
                    ...
                    <select  class="form-select" name="Habitacion_id" id="Habitacion_id" aria-label="Default select example">
                        <option value="">Seleccione</option>
                        @foreach ($habitaciones as $habitacion)
                        <option @if(old('Habitacion_id') == $habitacion->id ) selected
                            @else
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="date" class="form-control" name="fecha_entrada" id="fecha_entrada" value="{{ old('fecha_entrada') }}" aria-describedby="basic-addon1">

                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1">Fecha Salida</span>
                    <input type="date" class="form-control" name="fecha_salida" id="fecha_salida" value="{{ old('fecha_salida') }}" aria-describedby="basic-addon1">
                </div>

                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1">Numero de Huespedes</span>
                    <input type="number" class="form-control" name="Numero_de_huespedes" id="Numero_de_huespedes" value="{{ old('Numero_de_huespedes') }}" aria-describedby="basic-addon1">
                </div>
                <div class="row">
                    <div class="col-3">
